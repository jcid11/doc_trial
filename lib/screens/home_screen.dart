  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
            'Bienvenid@ ${Provider.of<UserBloc>(context, listen: false).userName},'),
      ),
      body: Padding(
    ...
    builder: (BuildContext context, HomeBloc homeBloc, Widget? child) {
      return Expanded(
        child: ListView.builder(
          itemCount: homeBloc.searchedList.length,
          itemBuilder: (BuildContext context, int index) {
            if (homeBloc.searchedList[index].email ==
                ...
                child: RawMaterialButton(
                  onPressed: () => Navigator.pushNamed(
                      ...
                      arguments: ScreenArguments(
                          homeBloc.searchedList[index].name,
                          additionalArgs: homeBloc.searchedList[index].email)),
                  child: Padding(
                    ...
                    child: ListTile(
                      ...
                      title: Text(homeBloc.searchedList[index].name),
                      subtitle: Text(homeBloc.searchedList[index].email),
                      trailing: Text(homeBloc.searchedList[index].age),
                    ),
                  ),
                ),
              ),
                  ...
                  RawMaterialButton(
                    ...
                    onPressed: () {
                      Provider.of<HomeBloc>(context, listen: false)
                          .toggleSearchButton();
                      if (!homeBloc.searchButtonActivation) {
                        homeBloc.setSearchWord('');
                        search.clear();
                      }
                    },
                    child: const Icon(
